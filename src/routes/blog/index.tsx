...
export default component$(() => {
    const blogs = [
        {
            title: 'New Website',
            description: 'This is the new website created in Qwik.',
            date: '10/02/2025',
            slug: 'new-website'
        }
    ];
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
                  {blogs.map(blog => ( 
                    <div key={blog.slug} class="bg-gray-800 p-4 rounded-lg shadow-lg">
                      ...
                      <a key={blog.slug} href={`/blog/${blog.slug}`} class="block mt-2 text-white p-2 rounded-lg bg-black text-center hover:bg-gray-700 transition">
                        Open blog
                      </a>
                    </div>
                  ))}
